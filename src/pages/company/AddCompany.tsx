...
const AddCompany = () => {
	...
	// 	useAuth0();
	//TODO::Need to work out the auth token and cross referencing this on the backend
	...
	return (
		<div className="bg-white p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-4xl">
			<h2 className="text-xl font-extrabold text-center mb-6 text-gray-900">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
					...
					<div>
						...
						<input
							...
							className={`mt-1 block w-full px-2 py-2 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 ${
