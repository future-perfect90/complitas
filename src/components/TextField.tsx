		...
		return (
			<div className="flex items-center space-x-2">
				...
				<input
					...
					required={required}
					disabled={disabled}
					className="px-2 py-1 border rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 text-[#212529] dark:text-[#F8F9FA] disabled:bg-gray-200 disabled:cursor-not-allowed dark:disabled:bg-gray-700"
				/>
			</div>
		);
	} else {
